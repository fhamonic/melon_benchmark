...
instances = [row['instance'] for row in readCSV(
    'results/dijkstra/dimacs/melon_static_graph.csv')]
...
data = [
    ...
    [int(float(row['time_ms']))
     for row in readCSV('results/dijkstra/dimacs/lemon_static_graph.csv')],
    [int(float(row['time_ms']))
     for row in readCSV('results/dijkstra/dimacs/melon_static_graph.csv')]
]
