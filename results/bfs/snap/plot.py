...
instances = [row['instance'] for row in readCSV(
    'results/bfs/snap/melon_static_digraph.csv')]
libs = ["BGL_adjacency_list_vecS", "BGL_compressed_sparse_row_graph",
        "LEMON_StaticDigraph", "MELON_StaticDigraph"]
data = [
    [int(float(row['time_ms']))
     for row in readCSV('results/bfs/snap/bgl_adjacency_list_vecS.csv')],
    [int(float(row['time_ms']))
     for row in readCSV('results/bfs/snap/bgl_compressed_sparse_row.csv')],
    [int(float(row['time_ms']))
     for row in readCSV('results/bfs/snap/lemon_static_digraph.csv')],
    [int(float(row['time_ms']))
     for row in readCSV('results/bfs/snap/melon_static_digraph.csv')]
]
...
plt.savefig('results/bfs/snap/plot.png')
