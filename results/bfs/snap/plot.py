...
instances = [row['instance'] for row in readCSV(
    'results/bfs/snap/melon_static_graph.csv')]
...
data = [
    ...
    [int(float(row['time_ms']))
     for row in readCSV('results/bfs/snap/lemon_static_graph.csv')],
    [int(float(row['time_ms']))
     for row in readCSV('results/bfs/snap/melon_static_graph.csv')]
]
