...
instances = [row['instance'] for row in readCSV(
    'results/dfs/snap/melon_static_graph.csv')]
...
data = [
    ...
    [int(float(row['time_ms']))
     for row in readCSV('results/dfs/snap/lemon_static_graph.csv')],
    [int(float(row['time_ms']))
     for row in readCSV('results/dfs/snap/melon_static_graph.csv')]
]
