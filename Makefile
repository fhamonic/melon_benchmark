...
dijkstra-benchmark-dimacs:
	...
	./build/dijkstra_benchmark_dimacs_lemon_static_graph > results/dijkstra/dimacs/lemon_static_graph.csv
	./build/dijkstra_benchmark_dimacs_melon_static_graph > results/dijkstra/dimacs/melon_static_graph.csv
...
dijkstra-benchmark-snap:
	...
	./build/dijkstra_benchmark_snap_lemon_static_graph > results/dijkstra/snap/lemon_static_graph.csv
	./build/dijkstra_benchmark_snap_melon_static_graph > results/dijkstra/snap/melon_static_graph.csv
...
bfs-benchmark-snap:
	...
	./build/bfs_benchmark_snap_lemon_static_graph > results/bfs/snap/lemon_static_graph.csv
	./build/bfs_benchmark_snap_melon_static_graph > results/bfs/snap/melon_static_graph.csv
...
dfs-benchmark-snap:
	...
	./build/dfs_benchmark_snap_lemon_static_graph > results/dfs/snap/lemon_static_graph.csv
	./build/dfs_benchmark_snap_melon_static_graph > results/dfs/snap/melon_static_graph.csv
